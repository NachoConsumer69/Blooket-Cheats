...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Minesraft2/Blooket-Cheats/main/autoupdate/global/useAnyBlook.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1692366544737 || iframe.contentWindow.confirm(error)) cheat();
    }
